                ...
                Button {
                    if checkDataFull() {
                        if let selectedImage {
                            let car = Car(make: make, model: model, year: year, mileage: mileage, vin: vin, spendings: [], imageData: selectedImage.jpegData(compressionQuality: 0.8))
...
extension String {
    ...
    static let valueIcon = "valueIconCS"
    static let workIcon = "workIconCS"
    static let notesIcon = "notesIconCS"
}
